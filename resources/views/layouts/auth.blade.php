...
<head>
 ...
 <title>{{ config('app.name', 'Online Food Order Management System') }}</title>
 <!-- Scripts -->
            ...
            <span class="navbar-toggler-icon"></span>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="nav-link dropdowntoggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
